...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        img = PhotoImage(file='ModeSelect7.png') #이미지 읽고
...
class Page1(tk.Frame):
    def __init__(self, parent, controller):
        ...
        img = PhotoImage(file='ModeSelect7.png') 
...
class Page2(tk.Frame):
    def __init__(self, parent, controller):
        ...
        img = PhotoImage(file='Page27.png') 
        lbl = Label(self, image=img)
        lbl.image = img
        lbl.pack(padx=0, pady=0)
        ...
        btn_stop = PhotoImage(file='stop.png') 
...
class Page3(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        img = PhotoImage(file='Page37.png') 
        lbl = Label(self, image=img)
        lbl.image = img
        lbl.pack(padx=0, pady=0)
...
class Page4(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        img = PhotoImage(file='Page47.png') 
        lbl = Label(self, image=img)
        lbl.image = img
        lbl.pack(padx=0, pady=0)
...
class Page5(tk.Frame):
    def __init__(self, parent, controller):
        tk.Tk.flag =0
        tk.Frame.__init__(self, parent)
        img = PhotoImage(file='Page57.png') 
        lbl = Label(self, image=img)
        lbl.image = img
        lbl.pack(padx=0, pady=0)
