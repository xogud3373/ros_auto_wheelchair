...
def Is_door_check():
    global count, lidar_ranges, mode
    count += 1
    print("-----------------------")
                ...
                for second_door in range(first_door_idx + 5, 90):
                    ...
                    if lidar_ranges[second_door + 1] < lidar_ranges[second_door] - 0.8:
                        ...
                        if door_width > 0.7 and door_width < 1.0:
                            isdoor = True
                            print("보정전 첫번째 문틀 인덱스 : %d"%first_door_idx)
                            print("보정전 두번째 문틀 인덱스 : %d"%second_door_idx)
                            print("보정전 정왼문이고 문 폭 : %.8f"%door_width)
                            ...
                            print("첫번째 문틀 인덱스 : %d"%cor_first_door_idx)
                            print("두번째 문틀 인덱스 : %d"%cor_second_door_idx)
                            print("정왼문이고 문 폭 : %.8f"%door_width)
                            
                            print(lidar_ranges)
                            #Calc_Door_Pos(first_door_len, second_door_len, first_door_ang, second_door_ang, 0, door_width)    
                            break     
                        else:
                            print("문1X")
            ...
            if lidar_ranges[first_door_idx + 1] > lidar_ranges[first_door_idx] + 1:
                for second_door in range(first_door_idx + 5, 360):
                    ...
                    if lidar_ranges[second_door + 1] < lidar_ranges[second_door] - 0.8:
                        ...
                        if door_width > 0.7 and door_width < 1.0:
                            isdoor = True
                            print("보정 전 첫번째 문틀 인덱스 : %d"%first_door_idx)
                            print("보정 전 두번째 문틀 인덱스 : %d"%second_door_idx)
                            print("보정 전 정오문이고 문 폭 : %.8f"%door_width)
                    ...
                    for second_door in range(0, 90):
                        ...
                        if lidar_ranges[second_door + 1] < lidar_ranges[second_door] - 0.8:
                            ...
                            if door_width > 0.7 and door_width < 1.2:
                                ...
                                print("보정전 첫번째 문틀 인덱스 : %d"%first_door_idx)
                                print("보정전 두번째 문틀 인덱스 : %d"%(second_door_idx))
                                print("보정전 정정문이고 문 폭 : %.8f"%door_width)
                ...
                for second_door in range(first_door_idx + 5, 135):
                    ...
                    if lidar_ranges[second_door + 1] < lidar_ranges[second_door] - 0.8:
                        ...
                        if door_width > 0.7 and door_width < 1.0:
                            ...
                            print("보정 전 첫번째 문틀 인덱스 : %d"%first_door_idx)
                            print("보정 전 두번째 문틀 인덱스 : %d"%second_door_idx)
                            print("보정 전 왼쪽문이고 문 폭 : %.8f"%door_width)
                            ...
                            print("첫번째 문틀 인덱스 : %d"%cor_first_door_idx)
                            print("두번째 문틀 인덱스 : %d"%cor_second_door_idx)
                            print("왼쪽문이고 문 폭 : %.8f"%door_width)

                            #Calc_Door_Pos(first_door_len, second_door_len, first_door_ang, second_door_ang, 1, door_width)    
                            break     
                        else:
                            print("문X")
                ...
                for second_door in range(first_door_idx + 5, 360):
                    ...
                    if lidar_ranges[second_door + 1] < lidar_ranges[second_door] - 0.8:
                        ...
                        if door_width > 0.7 and door_width < 1.0:
                            ...
                            print("보정 전 첫번째 문틀 인덱스 : %d"%first_door_idx)
                            print("보정 전 두번째 문틀 인덱스 : %d"%second_door_idx)
                            print("보정 전 오른쪽문이고 문 폭 : %.8f"%door_width)
                            ...
                            print("첫번째 문틀 인덱스 : %d"%cor_first_door_idx)
                            print("두번째 문틀 인덱스 : %d"%cor_second_door_idx)
                            print("오른쪽문이고 문 폭 : %.8f"%door_width)

                            #Calc_Door_Pos(first_door_len, second_door_len, first_door_ang, second_door_ang, 2)    
...
def Calc_Door_Pos(first_len, second_len, first_ang, second_ang, mode, door_width):
    ...
    #rint('%.8f %.8f %.8f'%(door_width, center_x_pos, center_y_pos))
    #print("fx : %.8f"%first_x_pos)
    #print("fy : %.8f"%first_y_pos)
    #print("sx : %.8f"%second_x_pos)
    #print("sy : %.8f"%second_y_pos)
